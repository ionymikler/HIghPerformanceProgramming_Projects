...
main(int argc, char *argv[]) {
    ...
    double ***u_d = malloc_3d_device(N,N,N, &data_u);
    double ***output_u_d = malloc_3d_device(N,N,N, &data_out);
    double ***f_d = malloc_3d_device(N,N,N,&data_f);
    ...
    int iter = 0;
    int *p_iter = &iter;
    jacobi(u, data_u,output_u, data_out, f, data_f, N, iter_max, tolerance);
